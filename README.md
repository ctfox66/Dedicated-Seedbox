[中文Readme](https://github.com/ctfox66/Dedicated-Seedbox/blob/main/README-zh.md)
# !! ALERT
BBR v3 is currently unavailable

# Seedbox Installation Script
## Usage
`bash <(wget -qO- https://raw.githubusercontent.com/ctfox66/Dedicated-Seedbox/main/Install.sh) -u <username> -p <password> -c <Cache Size(unit:MiB)> -q <qBittorrent Version> -l <libtorrent Version> -b -v -r -3 -x -o`
#### Options
	1. -u: username 
	2. -p: password
	...
	11. Customize ports
#### Example
`bash <(wget -qO- https://raw.githubusercontent.com/ctfox66/Dedicated-Seedbox/main/Install.sh) -u jerry048 -p 1LDw39VOgors -c 3072 -q 4.3.9 -l v1.2.19 -b -r -x`
